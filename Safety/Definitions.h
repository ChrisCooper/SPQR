...
SQUARE{
       ...
       int freePerson[NUMRESOURCES];         //Whether or not there is a person available to send for each resource
...
PERSON{
       int x, y, gridX, gridY;                           //The persons location in pixels and grid coordinates
