...
`\___x___/'(_)`\__)(_) (_)  ()  ()  ()
      ...
      See in-game instructions for game information.
		...
		*ALL PICTURES BY CHRIS COOPER (except the sword in the menu 
			and the bathing, wine, and education icons)
		*ALL CODE EXCLUSIVLEY BY CHRIS COOPER
		*ALL MUSIC BY CHRIS COOPER
		*SOUND EFFECTS BY SIERRA (CAESAR III AND ZEUS)
